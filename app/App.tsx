  ...
  return (
    <main className="container mx-auto max-w-lg xl:max-w-screen-xl h-screen max-h-screen overflow-hidden px-4">
      <div className="flex flex-col xl:flex-row xl:flex-wrap h-full pt-6">
        ...
        <div className="basis-full xl:basis-1/2 max-h-1/2 xl:max-h-full xl:w-1/2 pb-12">
          <label>
            ...
            <div className="overflow-y-auto h-full w-full px-5 py-2 font-medium bg-slate-100 border border-b-4 border-r-4 border-black rounded-lg shadow-lg hover:shadow-sm">
              {parseHTML ? (
